...
self.getHost = function getHost(url) {
    try { return new URL(url).hostname.toLowerCase(); } catch (e) { return ''; }
}

self.getETLD1 = function getETLD1(host) {
    if (!host) return '';
...
self.isThirdParty = function isThirdParty(topETLD1, hostETLD1) {
